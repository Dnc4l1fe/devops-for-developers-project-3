...
# Публичный доступ как в project-22: reverse SSH tunnel на VPS + HTTPS на VPS.
DOMAIN ?= myproj76.ru
...
RELAY_PID_FILE ?= /tmp/vps-relay-project22.pid
RELAY_LOG ?= /tmp/vps-relay-project22.log
